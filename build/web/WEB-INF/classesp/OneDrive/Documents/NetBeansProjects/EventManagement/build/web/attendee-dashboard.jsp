...
<body>
    ...
    <div class="container mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <small class="text-muted">
                                        <%= event.getDate() %> at <%= event.getTime() %><br>
                                        <%= event.getLocation() %>
                                    </small>
                                </p>
                                <a href="view-event?id=<%= event.getEventId() %>" class="btn btn-primary btn-sm">View Details</a>
                            </div>
                        </div>
                    </div>
                <% } %>
        ...
        <% } else { %>
        <div class="alert alert-info">To see Events Go To <a href="events">Dashboard.</a></div>
        <% } %>
    </div>
</body>
</html>